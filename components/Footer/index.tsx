          ...
          <div className="-mx-4 flex flex-wrap ">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                Securely redact sensitive information <br></br>with RE-DACT.
                </p>
...
<div className="flex justify-end w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12 ">
            ...
            <div className="flex justify-end w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">
                  Support & Help
                </h2>
